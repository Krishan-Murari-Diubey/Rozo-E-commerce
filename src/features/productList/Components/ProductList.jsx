...
import { fetchAllProductAsync, fetchProductsByFiltersAsync, selectAllProducts,selectTotalItems,selectCategories,selectBrand, fetchProductsByBrandAsync, fetchProductsByCategoriesAsync} from "../ProductSlice";
...
setFilter(newFilter)
  ...
  useEffect(()=>{
   dispatch(fetchProductsByBrandAsync())
